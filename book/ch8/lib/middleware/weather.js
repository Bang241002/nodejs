const getWeatherData = () => [
    {
        ...
        forecastUrl: 'http://api.weather.gov/fridpoints/PQR/112,103/forecast', 
        iconUrl:'http:/api.weather.gov/icons/land/day/tsra,40?size=medium',
        weather: 'Chance Showers And Thunderstoorms',
        temp: '59 F'
    },
        ...
        weather: 'Scattered Showrs And Thunderstorms',
        temp: '51 F'
    },

    {
        ...
        forecastUrl: 'http://api.weather.gov/gridpoint6s/PQR/73,120/forecast', 
